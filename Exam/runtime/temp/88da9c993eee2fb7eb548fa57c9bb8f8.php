...
<div class="layui-row layui-col-space15">
    ...
    <div class="lhj-content layui-col-md3">
        <a href='<?php echo url("/admin/County/current","cityId=$vo[id]"); ?>' class="layui-btn"><?php echo $vo['name']; ?></a>
    </div>
    <?php endforeach; endif; else: echo "" ;endif; ?>
</div>
