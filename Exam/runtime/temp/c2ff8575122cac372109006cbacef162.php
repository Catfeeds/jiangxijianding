...
<div class="layui-card-body">
    <table class="layui-table">
        ...
        <tbody>
        <?php if(is_array($applyCertificate) || $applyCertificate instanceof \think\Collection || $applyCertificate instanceof \think\Paginator): $i = 0; $__LIST__ = $applyCertificate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
            <td id="id"><?php echo $i; ?></td>
            <td><?php echo $vo['apply_num']; ?></td>
            <td><?php echo $vo['used_num']; ?></td>
            <td><?php echo $vo['unused_num']; ?></td>
            <td><?php echo $vo['error_num']; ?></td>
            <td><?php echo $vo['repair_num']; ?></td>
            <td><?php echo $vo['create_time']; ?></td>
            <td><?php echo config('certMessage')[$vo['status']]; ?></td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
    </table>
    <div class="layui-fluid tp-pages">
        <?php echo $applyCertificate->render(); ?>
    </div>
</div>
