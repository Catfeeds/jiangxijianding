<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:117:"D:\phpStudy\PHPTutorial\WWW\JiangXiJianDing\Exam\public/../application/learning\view\topic\official_add_describe.html";i:1545017021;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    layui.use(['form', 'layer','jquery'], function () {
        ...
        form.on('submit(formSubmit)', function (data) {
            data=data.field;
            $.ajax({
                url:'/api/LearningTopicOfficial/officialAddDescribe',
                type:'post',
                data:data,
                dataType:'json',
