<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:114:"D:\phpStudy\PHPTutorial\WWW\JiangXiJianDing\Exam\public/../application/learning\view\topic\official_add_judge.html";i:1545017021;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div style="padding: 15px;">
        <form class="layui-form" action="" id="addform">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block a">
                    <input type="radio" name="answer" <?php echo $datas['answer']=='0'?'checked': '';; ?> value="0" title="正确">
                    <input type="radio" name="answer" <?php echo $datas['answer']=='1'?'checked': '';; ?> value="1" title="错误">
                </div>
            </div>
...
<script>
    layui.use(['form', 'layedit', 'jquery'], function(){
        ...
        form.on('submit(formSubmit)', function (data) {
            ...
            $.ajax({
                url:'/api/LearningTopicOfficial/addJudge',
                type:'post',
                data:data,
                dataType:'json',
