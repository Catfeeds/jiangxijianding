<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"D:\phpStudy\PHPTutorial\WWW\JiangXiJianDing\Exam\public/../application/cms\view\guide\show.html";i:1545183598;s:91:"D:\phpStudy\PHPTutorial\WWW\JiangXiJianDing\Exam\application\common\view\layout\layout.html";i:1545212656;s:94:"D:\phpStudy\PHPTutorial\WWW\JiangXiJianDing\Exam\application\common\view\navigation\index.html";i:1545017016;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <a><cite>栏目
        ...
        <div class="layui-card-body">
            <table class="layui-table">
                ...
                <tr>
                    <td><?php echo $i; ?></td>
                    <td class="title<?php echo $v['id']; ?>"><?php echo $v['guide_name']; ?></td>
                    <td>
                        <?php echo $v['create_time']; ?>
                    </td>

                    <td>
                        <button class="layui-btn layui-btn-normal layui-btn-xs edit" data-value="<?php echo $v['id']; ?>"><i class="layui-icon"></i></button>
                        <button class="layui-btn layui-btn-danger layui-btn-xs delete" data-value="<?php echo $v['id']; ?>"><i class="layui-icon"></i></button>
